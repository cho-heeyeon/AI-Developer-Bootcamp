...
if image is None:
    raise FileNotFoundError("검증용 ROI 이미지를 찾을 수 없습니다.")
...
if len(diameters) == 0:
    raise RuntimeError("유효한 외경 측정값이 없습니다.")
...
actual_mm = float(
    input("새 데이터의 실제 계측기 외경(mm)을 입력하세요 : ")
)
...
print()
print("저장 완료 : Day017-2/validation_result.jpg")